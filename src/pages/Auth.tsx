...
function Auth({ redirectAfterAuth }: AuthProps = {}) {
  ...
  return (      <div className="min-h-screen flex flex-col bg-accent">

      
      {/* Auth Content */}
      <div className="flex-1 flex items-center justify-center bg-accent">
        <div className="flex items-center justify-center h-full flex-col">
        <Card className="min-w-[350px] pb-0 border-0 rounded-none shadow-none">
          {step === "signIn" ? (
            <>
          ...
          <div className="py-4 px-6 text-xs text-center font-bold uppercase tracking-widest bg-primary text-primary-foreground border-t-2 border-border rounded-b-lg">
            Secured by{" "}
            <a
